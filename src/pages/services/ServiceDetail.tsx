    ...
    return (
      <div className="sd-error">
        <div className="sd-error-content">
          <h1>{isEn ? 'Service Not Found' : 'Hizmet Bulunamadı'}</h1>
    ...
    >
      ...
      <section className="sd-hero">
        ...
        <div className="container">
          <Link to="/" className="sd-back-link">
            ...
            {isEn ? 'Back to Services' : 'Hizmetlere Dön'}
          </Link>
          ...
          <div className="sd-hero-content">
            ...
            <div className="sd-hero-text">
              ...
              <div className="sd-hero-price">
                <span className="sd-price-label">{isEn ? 'Starting from' : 'Başlangıç'}</span>
      ...
      <section className="sd-section" data-animate>
        <div className="sd-section-inner">
          ...
          <div className="sd-section-content">
            <h2 className="sd-section-title">{isEn ? 'About This Service' : 'Bu Hizmet Hakkında'}</h2>
      ...
      {service.benefits && service.benefits.length > 0 && (
        <section className="sd-section">
          <div className="sd-section-inner" data-animate>
            ...
            <div className="sd-section-content">
              <h2 className="sd-section-title">{isEn ? 'What You Get' : 'Neler Elde Edersiniz'}</h2>
      ...
      {service.process && service.process.length > 0 && (
        <section className="sd-section">
          <div className="sd-section-inner" data-animate>
            ...
            <div className="sd-section-content">
              <h2 className="sd-section-title">{isEn ? 'How We Work' : 'Nasıl Çalışıyoruz'}</h2>
      ...
      <section className="sd-section">
        <div className="sd-section-inner" data-animate>
          ...
          <div className="sd-section-content">
            <h2 className="sd-section-title">{isEn ? 'Packages' : 'Paketler'}</h2>
              ...
              {service.packages.map((pkg, idx) => (
                ...
                >
                  <div className="sd-pkg-badges">
                    {pkg.isMonthly && <span className="sd-badge-pill monthly">{isEn ? 'Monthly' : 'Aylık'}</span>}
                    {pkg.isOptional && <span className="sd-badge-pill optional">{isEn ? 'Optional' : 'Opsiyonel'}</span>}
                    {pkg.highlight && <span className="sd-badge-pill featured">{isEn ? 'Recommended' : 'Önerilen'}</span>}
                  </div>
                  ...
                  <div className="sd-pkg-deliverables">
                    <h4>{isEn ? "What's Included" : 'İçerik'}</h4>
                    <ul>
      ...
      {service.faq && service.faq.length > 0 && (
        <section className="sd-section">
          <div className="sd-section-inner" data-animate>
            ...
            <div className="sd-section-content">
              <h2 className="sd-section-title">{isEn ? 'Frequently Asked Questions' : 'Sıkça Sorulan Sorular'}</h2>
      ...
      <section className="sd-cta">
        ...
        <div className="container">
          <div className="sd-cta-content" data-animate>
            <h2>{isEn ? 'Ready to Get Started?' : 'Başlamaya Hazır mısınız?'}</h2>
            <p>{isEn
              ? 'Contact us for a personalized quote tailored to your business needs.'
              : 'İşletmenizin ihtiyaçlarına özel fiyat teklifi almak için bizimle iletişime geçin.'
            }</p>
            <div className="sd-cta-buttons">
              <a href="https://wa.me/905310330687" className="sd-cta-btn sd-cta-btn-whatsapp" target="_blank" rel="noopener noreferrer">
